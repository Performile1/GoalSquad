/**
 * ============================================
 * GOALSQUAD - VERIFIED COMPLETE DATABASE
 * ============================================
 * 
 * EXAKT KOPIERAT FRÅN KÄLLFILER
 * 
 * Verifierat mot:
 * - auth-and-members.sql (EXAKT KOPIA)
 * - messaging-system.sql (EXAKT KOPIA)
 * - moq-and-warehouses.sql (EXAKT KOPIA)
 * - product-flow-tracking.sql (EXAKT KOPIA)
 * - merchant-branding.sql (logo kolumner)
 * - community-logos.sql (logo kolumner)
 * - product-attributes.sql (certifications, allergens)
 * - shipping-restrictions.sql (shipping kolumner)
 * 
 * INSTRUKTIONER:
...
-- ============================================
-- 1. PROFILES (från auth-and-members.sql + guardian_id)
-- ============================================
...
CREATE TABLE IF NOT EXISTS merchants (
  ...
  -- Logos (från merchant-branding.sql)
  logo_url TEXT,
...
-- ============================================
-- 3. PRODUCTS (från product-attributes.sql + shipping-restrictions.sql)
-- ============================================
...
CREATE TABLE IF NOT EXISTS products (
  ...
  -- Product attributes (från product-attributes.sql)
  certifications TEXT[] DEFAULT '{}',
  allergens JSONB DEFAULT '[]',
  nutritional_info JSONB,
  
  -- Shipping (från shipping-restrictions.sql)
...
-- ============================================
-- 4. COMMUNITIES (från community-logos.sql)
-- ============================================
...
CREATE TABLE IF NOT EXISTS communities (
  ...
  -- Logos (från community-logos.sql)
  logo_url TEXT,
  logo_square_url TEXT,
  logo_horizontal_url TEXT,
...
-- ============================================
-- 5. COMMUNITY MEMBERS (EXAKT från auth-and-members.sql)
-- ============================================
...
CREATE TABLE IF NOT EXISTS community_members (
  ...
  seller_profile_id UUID, -- VIKTIGT: Referens till seller_profiles (skapas senare)
...
-- ============================================
-- 8. CONSOLIDATION WAREHOUSES (från moq-and-warehouses.sql)
-- ============================================
...
-- ============================================
-- 9. WAREHOUSE INVENTORY (från product-flow-tracking.sql)
-- ============================================
...
-- ============================================
-- 10. MERCHANT SHIPMENTS (från product-flow-tracking.sql)
-- ============================================
...
-- ============================================
-- 11. MERCHANT SHIPMENT ITEMS (från product-flow-tracking.sql)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_merchant_shipment_items_shipment ON merchant_shipment_items(shipment_id);
CREATE INDEX IF NOT EXISTS idx_merchant_shipment_items_product ON merchant_shipment_items(product_id);

-- ============================================
-- 12. WAREHOUSE ALLOCATIONS (från product-flow-tracking.sql)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_warehouse ON warehouse_allocations(warehouse_id);
CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_order ON warehouse_allocations(order_id);
CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_product ON warehouse_allocations(product_id);

-- ============================================
-- 13. PENDING MOQ ORDERS (från moq-and-warehouses.sql)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_pending_moq_status ON pending_moq_orders(status);

-- ============================================
-- 14. SHIPMENTS (från moq-enhancements.sql)
-- ============================================
...
-- ============================================
-- 15. CONVERSATIONS (från messaging-system.sql)
-- ============================================
...
-- ============================================
-- 16. CONVERSATION PARTICIPANTS (från messaging-system.sql)
-- ============================================
...
-- ============================================
-- 17. MESSAGES (från messaging-system.sql)
-- ============================================
...
-- ============================================
-- 18. MESSAGE READS (från messaging-system.sql)
-- ============================================
...
-- ============================================
-- 19. BROADCAST MESSAGES (från messaging-system.sql)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_broadcast_target ON broadcast_messages(target_type, target_id);
CREATE INDEX IF NOT EXISTS idx_broadcast_sent ON broadcast_messages(sent_at DESC);

-- ============================================
-- 20. BROADCAST RECIPIENTS (från messaging-system.sql)
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_broadcast_recipients_unread ON broadcast_recipients(user_id) WHERE read_at IS NULL;
...
-- Profiles
DO $$ BEGIN CREATE POLICY "profiles_select_all" ON profiles FOR SELECT USING (true);
...
-- Merchants
DO $$ BEGIN CREATE POLICY "merchants_select_active" ON merchants FOR SELECT USING (is_active = true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "merchants_service_role_all" ON merchants FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Products
DO $$ BEGIN CREATE POLICY "products_select_active" ON products FOR SELECT USING (is_active = true AND is_available = true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "products_service_role_all" ON products FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Communities
DO $$ BEGIN CREATE POLICY "communities_select_active" ON communities FOR SELECT USING (is_active = true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "communities_service_role_all" ON communities FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Community Members
DO $$ BEGIN CREATE POLICY "community_members_select_all" ON community_members FOR SELECT USING (true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "community_members_service_role_all" ON community_members FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DO $$ BEGIN CREATE POLICY "order_items_service_role_all" ON order_items FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Warehouses
DO $$ BEGIN CREATE POLICY "warehouses_select_active" ON consolidation_warehouses FOR SELECT USING (is_active = true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "warehouses_service_role_all" ON consolidation_warehouses FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Warehouse Inventory
DO $$ BEGIN CREATE POLICY "warehouse_inventory_select_all" ON warehouse_inventory FOR SELECT USING (true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "warehouse_inventory_service_role_all" ON warehouse_inventory FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Conversations
DO $$ BEGIN CREATE POLICY "conversations_select_participant" ON conversations FOR SELECT USING (
  id IN (SELECT conversation_id FROM conversation_participants WHERE user_id = auth.uid())
);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "conversations_service_role_all" ON conversations FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Messages
DO $$ BEGIN CREATE POLICY "messages_select_participant" ON messages FOR SELECT USING (
  conversation_id IN (SELECT conversation_id FROM conversation_participants WHERE user_id = auth.uid())
);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "messages_service_role_all" ON messages FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

-- Broadcast Recipients
DO $$ BEGIN CREATE POLICY "broadcast_recipients_select_own" ON broadcast_recipients FOR SELECT USING (user_id = auth.uid());
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN CREATE POLICY "broadcast_recipients_service_role_all" ON broadcast_recipients FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
-- ============================================
-- 
-- 20 TABELLER SKAPADE (VERIFIED):
-- ✅ Core: profiles (med guardian_id), merchants, products, communities, community_members (med seller_profile_id), orders, order_items
-- ✅ Warehouses: consolidation_warehouses, warehouse_inventory, merchant_shipments, 
--    merchant_shipment_items, warehouse_allocations, pending_moq_orders, shipments
...
-- ✅ 3 Warehouses
--
-- ALLA KOLUMNER VERIFIERADE:
-- ✅ profiles.guardian_id (används i sellers/register)
-- ✅ community_members.status (VARCHAR(50))
-- ✅ community_members.seller_profile_id (UUID)
-- ✅ Alla logo kolumner (merchants, communities)
-- ✅ Alla product attributes (certifications, allergens, shipping)
--
-- NÄSTA STEG:
-- 1. Kör denna SQL i Supabase
-- 2. Hämta Supabase keys (Settings → API)
