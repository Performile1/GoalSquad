/**
 * ============================================
 * GOALSQUAD - COMPLETE DATABASE SETUP
 * ============================================
 * 
 * SINGLE FILE - ALL TABLES, INDEXES, POLICIES, SAMPLE DATA
 * 
 * INSTRUCTIONS:
...
-- Pending MOQ
DO $$ BEGIN
  CREATE POLICY "pending_moq_select_all" ON pending_moq_orders FOR SELECT USING (true);
EXCEPTION WHEN duplicate_object THEN NULL; END $$;

DO $$ BEGIN
  CREATE POLICY "pending_moq_service_role_all" ON pending_moq_orders FOR ALL USING (auth.jwt() ->> 'role' = 'service_role');
EXCEPTION WHEN duplicate_object THEN NULL; END $$;
