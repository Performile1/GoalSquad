...
CREATE INDEX IF NOT EXISTS idx_community_products_community ON public.community_products(community_id);
CREATE INDEX IF NOT EXISTS idx_community_products_seller ON public.community_products(seller_id);

-- Campaigns: community-scoped lookups
...
CREATE INDEX IF NOT EXISTS idx_ledger_entries_seller ON public.ledger_entries(seller_id);
