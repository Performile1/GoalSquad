      ...
      <div className="bg-primary-900 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <h1 className="text-4xl font-bold mb-4">Community & Tillväxt</h1>
            <p className="text-xl text-white/80">
              Vi bygger relationer med föreningar och hjälper dem att växa
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            Vi arbetar nära med idrottsföreningar, skolklasser och klubbar för att förstå deras behov och hjälpa dem att nå sina finansieringsmål. Genom personlig support och kontinuerligt samarbete ser vi till att varje förening lyckas med sin försäljning.
          </p>
        </motion.div>
