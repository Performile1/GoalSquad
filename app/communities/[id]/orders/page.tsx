...
export default function CommunityOrders() {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch(`/api/communities/${communityId}/orders`);
  ...
  const filteredOrders = orders.filter(order => {
    const matchesSearch = order.orderNumber.toLowerCase().includes(search.toLowerCase()) ||
      ...
      (order.sellerName && order.sellerName.toLowerCase().includes(search.toLowerCase()));
    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-600">Hantera föreningens beställningar</p>
        </motion.div>
        ...
        >
          <div className="flex flex-col md:flex-row gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Sök efter ordernummer, kund eller säljare..."
                value={search}
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-sm font-semibold text-gray-700">Säljare</th>
