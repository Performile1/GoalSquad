...
import { AlertIcon, SearchIcon, TruckIcon } from '@/app/components/BrandIcons';
...
export default function SellerReturns() {
  ...
  const fetchReturns = async () => {
    try {
      const response = await apiFetch(`/api/sellers/${sellerId}/returns`);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-4xl font-bold text-gray-900">Mina returer</h1>
              <p className="text-gray-600">Översikt över alla returer från mina försäljningar</p>
            </div>
          </div>
        </motion.div>
            ...
            <div className="flex-1 min-w-[200px]">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Returnummer, ordernummer eller kund..."
