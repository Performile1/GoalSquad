...
async function seed() {
  ...
  const products = [
    { id: 'p1', merchant_id: 'm1', name: 'GoalSquad Träningsjacka', description: 'Vind- och vattenavvisande jacka perfekt för träning i alla väder.', sku: 'GS-JACKA-001', ean: '7312345678901', category: 'Sportkläder', brand: 'GoalSquad', base_price: 450, retail_price: 699, weight_grams: 420, length_mm: 350, width_mm: 280, height_mm: 80, stock_quantity: 200, stock_location: 'Stockholm', status: 'active' },
    { id: 'p2', merchant_id: 'm1', name: 'GoalSquad Fotboll', description: 'FIFA-godkänd fotboll i premiumkvalitet.', sku: 'GS-BOLL-001', ean: '7312345678902', category: 'Fotboll', brand: 'GoalSquad', base_price: 180, retail_price: 299, weight_grams: 450, length_mm: 220, width_mm: 220, height_mm: 220, stock_quantity: 150, stock_location: 'Stockholm', status: 'active' },
    { id: 'p3', merchant_id: 'm1', name: 'GoalSquad Träningsbyxor', description: 'Löparbyxor med reflexdetaljer.', sku: 'GS-BYXA-001', ean: '7312345678903', category: 'Sportkläder', brand: 'GoalSquad', base_price: 280, retail_price: 449, weight_grams: 320, length_mm: 300, width_mm: 250, height_mm: 50, stock_quantity: 180, stock_location: 'Stockholm', status: 'active' },
    { id: 'p4', merchant_id: 'm2', name: 'Nordic Vinterhandske', description: 'Värmeisolerade handskar för vinterträning.', sku: 'NG-HAND-001', ean: '7312345678904', category: 'Tillbehör', brand: 'Nordic Gear', base_price: 120, retail_price: 199, weight_grams: 180, length_mm: 250, width_mm: 150, height_mm: 40, stock_quantity: 300, stock_location: 'Malmö', status: 'active' },
    { id: 'p5', merchant_id: 'm2', name: 'Nordic Pannband', description: 'Svettavvisande pannband i merinoull.', sku: 'NG-PANN-001', ean: '7312345678905', category: 'Tillbehör', brand: 'Nordic Gear', base_price: 80, retail_price: 149, weight_grams: 45, length_mm: 200, width_mm: 80, height_mm: 20, stock_quantity: 250, stock_location: 'Malmö', status: 'active' },
    { id: 'p6', merchant_id: 'm2', name: 'Nordic Vattenflaska', description: 'BPA-fri flaska med isolering.', sku: 'NG-FLAS-001', ean: '7312345678906', category: 'Tillbehör', brand: 'Nordic Gear', base_price: 55, retail_price: 99, weight_grams: 300, length_mm: 250, width_mm: 80, height_mm: 80, stock_quantity: 400, stock_location: 'Malmö', status: 'active' },
  ];
